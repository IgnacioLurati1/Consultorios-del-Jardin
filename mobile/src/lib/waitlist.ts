/**
 * Lo que la pantalla necesita saber de la lista de espera sin preguntarle al servidor. Es
 * lo mismo que usa la página, para que las dos digan y bloqueen lo mismo.
 *
 * Los números de los topes no están acá: llegan con el estado de cada lista, así que
 * cambiarlos es tocar un solo lugar del backend.
 */
