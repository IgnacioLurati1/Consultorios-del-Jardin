...
export default function AppLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="pedir/index" options={{ title: "Solicitar turno" }} />
      ...
      <Stack.Screen name="novedades" options={{ title: "Avisos" }} />
      ...
      <Stack.Screen name="mis-numeros" options={{ title: "Números" }} />
      ...
      <Stack.Screen name="admin/avisos" options={{ title: "Avisos del consultorio" }} />
      <Stack.Screen name="admin/alquileres" options={{ title: "Alquileres" }} />
