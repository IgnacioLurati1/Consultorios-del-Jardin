...
export interface Appointment {
    ...
    state: string;
    /**
     * Cuándo dio de baja el turno el paciente. Solo se llena cuando la baja la hizo él,
     * no el profesional.
     *
     * Opcional porque la página y el servidor se publican por separado. Contra un
